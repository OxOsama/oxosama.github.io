...
const NotFoundPage = () => {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 relative bg-[#0d1117] overflow-hidden text-[#c9d1d9]">
            ...
            <div className="flex flex-col max-w-[800px] w-full z-10 gap-8">
                {/* Error Title Section */}
                <div className="flex flex-col gap-2 items-start animate-pulse-fast">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-white glitch-text mb-2" data-text="ERROR 404">ERROR 404</h1>
                    <p className="text-red-400 font-mono text-base md:text-lg flex items-center gap-2">
                        <AlertCircle size={20} />
                        PAGE_FAULT_IN_NONPAGED_AREA
                    </p>
                    <p className="text-[#8b949e] text-sm md:text-base font-normal max-w-lg">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 mt-4">
                    ...
                    <div className="flex gap-4 text-sm font-mono text-[#8b949e]">
                        <span className="select-none text-[#30363d]">|</span>
            ...
            <div className="absolute bottom-4 left-0 w-full text-center text-xs text-[#8b949e] font-mono">
