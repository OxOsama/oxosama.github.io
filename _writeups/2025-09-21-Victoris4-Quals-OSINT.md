---
title: "OSINT Writeup â€” IEEE VICTORIS4 CTF Quals"
header:
  teaser: /assets/images/Covers/victoris4.png
description: "After a full 24 hours in the `IEEE VICTORIS4 CTF` qualifications phase, Iâ€™m happy to share my write-up for three OSINT challenges I created: two Investigations (*Easy/Medium*) and one Geo (*Hard*), this is a step-by-step walkthrough aimed at beginners."
...
After a full 24 hours in the `IEEE VICTORIS4 CTF` qualifications phase, Iâ€™m happy to share my write-up for three OSINT challenges I created: two Investigations (*Easy/Medium*) and one Geo (*Hard*).
...
```txt
30 milliseconds.
Thatâ€™s all it took for a curious researcher to realize something wasnâ€™t right.
His SSH connections on a Debian Sid box feltâ€¦ heavy, CPU usage spiked without reason, A memory debugger whispered errors no one had ever seen before.
From that tiny anomaly unraveled one of the largest supply-chain compromises the open-source world has faced in years.
Somewhere inside the projectâ€™s commits hides a phantom maintainer â€” a name without a past, a presence without a trace.
He wasnâ€™t alone. Two more voices echoed alongside his, applying pressure, pushing changes, steering trust.
...
Name his allies.
Flag parts
The co-maintainerâ€™s full name â†’ fname-mname-lname
The date of his first commit â†’ mm/dd/yyyy
The names of two teammates who aided the pressure campaign â†’ fname-lname,fname-lname
Flag format
...
## <span style="color:#0056D2;">**Ugly Inside â€” The Leak Trace**</span>
...
### Description
``` 
The cold wind cuts across an empty plain, where rusting machines and scattered containers sleep under a blanket of snow â€” a lonely workshop standing against the wide horizon.
...
1. Characteristics of the place says that it's on `Alaskaâ€™s North Slope`
