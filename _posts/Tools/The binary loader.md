...
header:
  teaser: /assets/images/tools/binary_loader.jpg
ribbon: DarkGray
...
* Shows the help menu (equivalent to -h).
    ...
    ![alt text](/assets/images/tools/the_binary_loader/1.png)
...
![alt text](/assets/images/tools/the_binary_loader/2.png)
...
![alt text](/assets/images/tools/the_binary_loader/3.png)
...
![alt text](/assets/images/tools/the_binary_loader/4.png)
...
![alt text](/assets/images/tools/the_binary_loader/5.png)
![alt text](/assets/images/tools/the_binary_loader/6.png)
...
![alt text](/assets/images/tools/the_binary_loader/7.png)
