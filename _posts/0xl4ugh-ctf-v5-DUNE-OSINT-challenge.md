...
â£Iâ€Œnâ€ â£tâ£hâ€‹eâ€‹ â€Œwâ¤oâ€Œrâ¢lï»¿dï»¿ â¢oâ€‹fâ€‹ â€ŒDâ uâ€Œnâ eâ£,â£ â¤eâ€vâ€‹eâ£râ¤yâ tâ€Œhâ€‹iï»¿nâ¢gâ€Œ â€Œhâ£aâ€Œsï»¿ â€‹tâ¢wâ€oâ€‹ â¤fï»¿aâ€Œcâ€eâ¢sâ£ â£dâ€‹eï»¿pâ€‹eï»¿nâ€Œdâ€Œiâ¤nâ gâ¢ ï»¿oâ¢nâ€Œ â€‹wâ€‹hâ¤oâ£ â¢yâ¢oâ¢uâ¢ â¤aâ¤râ€‹eâ¢.â€
â Aâ£ â¢Fâ£râ¤eâ mâ£eâ nâ€ â€câ£aâ€nâ¢ â¢bâ£eï»¿ ï»¿aâ  â£tâ€‹râ¤uâ€Œsâ€Œtâ¢eâ£dâ€‹ â€Œaï»¿lâ€lï»¿yâ€‹ â€‹tâ¤oâ€Œ â€‹Hâ€‹oâ€Œuï»¿sï»¿eâ¤ â€ŒAâ€Œtâ€Œrâ€‹eâ€‹iï»¿dâ€eâ£sï»¿â€¦â€‹ â¤oâ£râ£ â£aï»¿ ï»¿nâ¤iâ€Œgâ¢hâ¢tâ¤mâ€aâ¢râ€Œeâ€Œ ï»¿tâ¤oâ  â€‹Hâ£oâ£uâ sï»¿eâ€‹ Harkonnen.
...
Your mission is to help us understand what really happened â€“ and recover what was taken.

Find our official Presence on the Open Web.

From there, track down where we keep our harvestersâ€™ Source Code.
...
Be aware of the Many Fakes, If you read the signs correctly and follow every breadcrumb, youâ€™ll uncover all stolen fragments.
...
The website is intentionally configured so that only Google indexes it reliably, other search engines either donâ€™t index it or are very slow to pick it up.

Now that we have the `Arrakis-Colony`â€™s official presence on the Open Web, we search the whole website til we find the contact-us section which has links for [GitHub](https://github.com/arrakis-flows), [LinkedIn](https://www.linkedin.com/in/duke-of-arrakis/) and [Telegram](https://t.me/Duke_of_arrakis_bot), the keywords had `Source Code` and`Packages` so we start with GitHub.
...
We need to find that thread, we search for that `Reddit of the dark web` forum to find out that itâ€™s actually `Dread`, so we setup our Tor browser and go there searching for it.
...
>Useless Note `ã„Ÿ( â–”, â–” )ã„`
>
>    *The thread is posted by `Duke_of_Arrakis` who is `Paul Atriedes` if youâ€™re a fan of the dune world*
>    
>    *But that doesnâ€™t change anything.*
...
Searching with the hash on `MalwareBazaar` will result in this [sample](https://bazaar.abuse.ch/sample/6605d218eafede3708c81a86580e51a7ccd072e0231c47692e9dc1ac0e90f2c6/), which has the following tags indicating itâ€™s our desired sample.
...
This means itâ€™s `IDA` time; I opened the strings tab then tracked where the `Part-3` string was used in the decompiled code; it was `RegCreateKeyExA` followed by `RegSetValueExA` and `RegCloseKey`, so we put a breakpoint there and inspect the value in the â€˜stringâ€™ variable.
...
I also hope you didnâ€™t curse my name for all those fake flags `Â¯\_(ãƒ„)_/Â¯`
